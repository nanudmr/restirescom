...
$nitropack_functions_file = '/Applications/MAMP/htdocs/restires-git/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/Applications/MAMP/htdocs/restires-git/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_ADVANCED_CACHE_VERSION', '1.5.6');
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_78b5aebca058e32dc5e49ba91820d1c1' );
